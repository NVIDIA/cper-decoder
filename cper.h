...
const int signatureEndMarker =
    255; // Each byte of the signature end must be 0xFF which is 255 in int

/**
 * Consists of strings to match each section type
 * @note: The section type (GUID) is in the order it is stored in memory in the
 *log file
 **/
const std::string
    nvda("f244526d1227ec11bea7cb3fdb95c786"); // NVIDIA CPER Section Type
const std::string memErr(
    "1411bca5646fde4eb8633e83ed7c83b1"); // General Memory Error Section Type
const std::string pciExpress(
    "54e995d9c1bb0f43ad91b44dcb3c6f35"); // PCI Express Error Section Type
const std::string armProcErr(
    "163d9ee111bce4119caac2051d5d46b0"); // ARM Processor Error Section Type
